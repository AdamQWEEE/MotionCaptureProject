...
public class SwordDirManager : MonoBehaviour
{
    public enum Dir { Normal = 0, Focus = 1,}
    ...
    [SerializeField] private Transform gripNormal;
    [SerializeField] private Transform gripFocus;
